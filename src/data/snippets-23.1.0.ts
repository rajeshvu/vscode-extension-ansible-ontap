...
export const snippets_23_1_0: SnippetItem[] = [
    ...
    },
    {
        ...
        "description": "- netapp.ontap.na_ontap_broadcast_domain",
        "body": "\n- name: If partial match, remove e0d-12 from new_ansible_domain & create new domain\n    ansible_domain with port e0d-12 REST\n  netapp.ontap.na_ontap_broadcast_domain:\n    state: present\n    username: '{{ netapp_username }}'\n    password: '{{ netapp_password }}'\n    hostname: '{{ netapp_hostname }}'\n    from_name: new_ansible_domain\n    name: ansible_domain\n    mtu: 1200\n    ipspace: Default\n    ports:\n    - khutton-vsim1:e0d-12\n"
    },
    {
    ...
    },
    {
        ...
        "description": "- netapp.ontap.na_ontap_job_schedule",
        "body": "\n- name: Create Job for 11.30PM at 10th of January, April, July, October for ZAPI and\n    REST\n  netapp.ontap.na_ontap_job_schedule:\n    state: present\n    name: jobName\n    job_minutes: 30\n    job_hours: 23\n    job_days_of_month: 10\n    job_months: 1,4,7,10\n    month_offset: 1\n    hostname: '{{ netapp_hostname }}'\n    username: '{{ netapp_username }}'\n    password: '{{ netapp_password }}'\n"
    },
    {
        "label": "Create Job for 11.30PM at 10th of January, April, July, October for ZAPI and REST",
        "description": "- netapp.ontap.na_ontap_job_schedule",
    ...
    },
    {
        ...
        "description": "- netapp.ontap.na_ontap_job_schedule",
        "body": "\n- name: Create Job for 11.30PM at 10th of January when using REST and February when\n    using ZAPI !!!\n  netapp.ontap.na_ontap_job_schedule:\n    state: present\n    name: jobName\n    job_minutes: 30\n    job_hours: 23\n    job_days_of_month: 10\n    job_months: 1\n    hostname: '{{ netapp_hostname }}'\n    username: '{{ netapp_username }}'\n    password: '{{ netapp_password }}'\n"
    },
    {
        "label": "Delete Job",
        "description": "- netapp.ontap.na_ontap_job_schedule",
    ...
    },
    {
        ...
        "description": "- netapp.ontap.na_ontap_snapmirror",
        "body": "\n- name: Create SnapMirror relationship - SVM DR (creating and peering destination\n    svm)\n  tags: create_svmdr\n  netapp.ontap.na_ontap_snapmirror:\n    state: present\n    source_endpoint: null\n    cluster: '{{ _source_cluster }}'\n    path: '{{ source_vserver + '':'' }}'\n    destination_endpoint:\n      cluster: '{{ _destination_cluster }}'\n      path: '{{ destination_vserver_SVMDR + '':'' }}'\n    create_destination:\n      enabled: true\n    hostname: '{{ destination_hostname }}'\n    username: '{{ username }}'\n    password: '{{ password }}'\n    https: true\n    validate_certs: false\n"
    },
    {
    ...
    },
    {
        ...
        "description": "- netapp.ontap.na_ontap_volume",
        "body": "\n- name: Modify volume dr protection (vserver of the volume must be in a snapmirror\n    relationship)\n  netapp.ontap.na_ontap_volume:\n    state: present\n    name: ansibleVolume\n    vserver_dr_protection: protected\n    vserver: '{{ vserver }}'\n    hostname: '{{ netapp_hostname }}'\n    username: '{{ netapp_username }}'\n    password: '{{ netapp_password }}'\n    https: false\n"
    },
    {
